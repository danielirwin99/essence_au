...
const Nike = () => {
  ...
  const nike = "nike";
  const filtered = Object.entries(sneakers).filter(([key, obj]) =>
    obj.brand.toLowerCase().includes(nike.toLowerCase())
  );
  ...
  function onSelectionChange(e) {
    ...
    copyArray.sort((a, b) => {
      if (sortDirection === "HIGH_TO_LOW") {
        ...
        return sortDirection ? b.price - a.price : a.price - b.price;
